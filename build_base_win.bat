...
cmake -G "%VS_STRING%" -DADTF_DIR="%ADTF3_DIR%" -DQt_DIR="%QT_DIR%" -DQT_QMAKE_EXECUTABLE="%QMAKE_EXE%" "%SOURCE_DIR%" -DCMAKE_BUILD_TYPE=RelWithDebInfo ../src/aadcBase
